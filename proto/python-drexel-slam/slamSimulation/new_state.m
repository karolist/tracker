...
function new_state(zlaser)
    ...
    %+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    % PART 3: ENTER IN EQUATIONS TO GIVE INITIAL ESTIMATE FOR LANDMARK POSITION
    %+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

    % Calculate landmark position in global frame
    x = ??;     % x-position of landmark in global frame
    y = ??;     % y-position of landmark in global frame
